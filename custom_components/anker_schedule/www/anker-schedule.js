/*
 * Anker Schedule — Lovelace card bundled with custom_components/anker_schedule.
...
class AnkerScheduleCard extends HTMLElement {
  static getConfigElement() {
    return document.createElement("anker-schedule-editor");
  }
...
if (!customElements.get("anker-schedule-editor")) {
