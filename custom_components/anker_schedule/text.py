"""Text entity storing the compact Anker schedule."""
...
async def async_setup_entry(
    ...
    async_add_entities([AnkerScheduleText(coordinator, entry)])


class AnkerScheduleText(TextEntity):
